...
// /**
// * TopologyTestDriver based test about stream processing of {@link
...
// KafkaStreamsWordCountApplication.WordCountProcessorApplication.INPUT_TOPIC;
// public static final String OUTPUT_TOPIC =
// KafkaStreamsWordCountApplication.WordCountProcessorApplication.OUTPUT_TOPIC;

// final Serde<String> stringSerde = Serdes.String();
// final JsonSerde<KafkaStreamsWordCountApplication.WordCount> countSerde = new
// JsonSerde<>(KafkaStreamsWordCountApplication.WordCount.class);
// final Serde<Bytes> nullSerde = Serdes.Bytes(); //Serde for not used key
// private ConsumerRecordFactory<String, String> recordFactory = new
// ConsumerRecordFactory<>(
// stringSerde.serializer(), stringSerde.serializer()); //Key feed in as string,
// even read as Bytes
...
// KStream<Bytes, String> input = builder.stream(INPUT_TOPIC,
// Consumed.with(nullSerde, stringSerde));
// KafkaStreamsWordCountApplication.WordCountProcessorApplication app = new
// KafkaStreamsWordCountApplication.WordCountProcessorApplication();
// final Function<KStream<Bytes, String>, KStream<Bytes,
// KafkaStreamsWordCountApplication.WordCount>> process = app.process();

// final KStream<Bytes, KafkaStreamsWordCountApplication.WordCount> output =
// process.apply(input);
...
// System.out.println("Ignoring exception, test failing in Windows due this
...
// */
// private ProducerRecord<Bytes, KafkaStreamsWordCountApplication.WordCount>
// readOutput() {
// return testDriver.readOutput(OUTPUT_TOPIC, nullSerde.deserializer(),
// countSerde.deserializer());
// }

// /**
// * Read counts from output to map ignoring start and end dates
// * If existing word is incremented, it can appear twice in output and is
// replaced in map
// *
...
// //Feed word "Hello" to inputTopic and no kafka key, timestamp is irrelevant
// in this case
// testDriver.pipeInput(recordFactory.create(INPUT_TOPIC, nullKey, "Hello",
// 1L));
// //Read and validate output
// final ProducerRecord<Bytes, KafkaStreamsWordCountApplication.WordCount>
// output = readOutput();
// assertThat(output).isNotNull();
// assertThat(output.value()).isEqualToComparingFieldByField(new
// KafkaStreamsWordCountApplication.WordCount("hello", 1L, new Date(0), new
// Date(KafkaStreamsWordCountApplication.WordCountProcessorApplication.WINDOW_SIZE_MS)));
...
// testDriver.pipeInput(recordFactory.create(INPUT_TOPIC, inputRecords, 1L,
// 1000L)); //All feed in same 30s time window
